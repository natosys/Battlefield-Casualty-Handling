...
### Phase 1 — Statistical Foundation (Issues 1 ✓, 22 ✓, 2 ✓, 3 ✓, 24 ✓, 75 ✓, 157 ✓, 158 ✓, 189 ✓, 186 ✓, 195 ✓, 208 ✓, 331 ✓, 296 ✓)
...
UNBLOCKED (start now):
  ...
  #382 Nothing asserts the strategic evacuation section's published figures
       against `data/airlift/`, the four sibling experiments each having a
       protocol check and this one having none. The gap is measured rather
       than hypothetical: the section had drifted from its own evidence set
       since PR #379, printing 26.96 casualties still waiting at high
       intensity against a tracked 108.28. Raised from #362.
