...
| 388 | The post-operative intensive care gate has no tracked evidence set, so its published magnitudes cannot be audited | Medium | Medium | Open |
...
### Phase 1 — Statistical Foundation (Issues 1 ✓, 22 ✓, 2 ✓, 3 ✓, 24 ✓, 75 ✓, 157 ✓, 158 ✓, 189 ✓, 186 ✓, 195 ✓, 208 ✓, 331 ✓, 296 ✓, 382 ✓, 384 ✓, 387 ✓)
...
UNBLOCKED (start now):
  #388 The post-operative intensive care gate, same shape and same reason.
       `check_icu_gate_switch.R` covers the mechanism and asserts nothing
       about the magnitudes. #387's merge landed a runner module and check
       pattern it may share, so the two are best sequenced together but
       neither gates the other. Unblocked by the merge of #384.
