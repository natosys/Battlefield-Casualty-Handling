...
| `scripts/check_dow_calibration.R`  | Checks that neither shipped configuration's treated-cohort died-of-wounds rate overshoots the Ajax Bay historical bound, pooling independent measurements and treating the antithetic pair as the unit of analysis; exits non-zero on failure |
