...
| 368 | Role 4 surgical activity is not represented, so its demand is understated | Medium | Medium | Open |
...
### Phase 4 — Scenario Expansion (Issues 54 ✓, 9 ✓, 10 ✓, 57 ✓, 18 ✓, 23 ✓, 124 ✓, 160 ✓, 153 ✓, 148 ✓, 203 ✓, 206 ✓, 149 ✓, 151 ✓, 207 ✓, 295 ✓, 314 ✓)
...
UNBLOCKED (start now):
  ...
  #368 Role 4 surgical activity is not represented, so its demand is
       understated. Raised from #369 and rewritten after #371: the census
       reports only bed types and Role 4 is given no operating theatre, so a
       casualty released with the definitive repair outstanding loses that
       operation at boarding. Blocks the non-zero shipped default of #365's
       saturation threshold; the two are sequenced with this one first.
