...
| 333 | Resolve the two R2B holding thresholds, one name for two levers | Medium | Low | Open — in review (PR #334) |
| 335 | Sweep R2B holding capacity against the evacuation threshold | Medium | Medium | Open — gated on 333 |
...
### Phase 7 — Publication (Issues 238 ✓, 239 ✓, 240 ✓, 311 ✓, 315 ✓, 327 ✓)
...
BLOCKED (gated on other issues):
  #335 Joint sweep of R2B holding capacity against the evacuation threshold,
       ...
       Gated on #333, which gives the threshold a configuration entry.
