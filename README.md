...
| `.github/`                         | Pull request template and the GitHub Actions workflow that runs the fast suite, the lint ratchet and the seed-42 reproduction on every pull request against `main` |
