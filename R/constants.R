...
MODEL_ATTRIBUTE_KEYS <- c(
  "ame_departure_time", "ame_hold_start", "ame_icu_hold", "ame_icu_hold_minutes", "ame_icu_hold_start",
  ...
  "r2e_arrival_time", "r2e_departure_time", "r2e_evac", "r2e_handling", "post_definitive_hold_start", "r2e_post_op_hold_min", "r2e_post_op_hold_start",
  "r2e_post_op_min", "r2e_recovery_hold_start",
