...
### Phase 2 — Model Fidelity (Issues 8 ✓, 35 ✓, 37 ✓, 44 ✓, 6 ✓, 5 ✓, 43 ✓, 14 ✓, 161 ✓, 156 ✓, 173 ✓, 180 ✓, 178 ✓, 146 ✓)
...
### Phase 4 — Scenario Expansion (Issues 9 ✓, 10 ✓, 57 ✓, 18 ✓, 23 ✓, 148 ✓)
...
15b. ~~**Issue 148** — Replace `make_ln_arrival_generator()`'s fixed absolute per-minute rate cap of 5 with the mean-relative `cap_multiplier × mean_daily` the exponential generator has used since Issue #54, narrowing the cross-stream truncation spread from roughly 150-fold to under 6-fold. Raised Issue #203 for the residual, that a cap of any multiplier holds realised generation below the configured mean.~~ — **Merged PR #202.**
