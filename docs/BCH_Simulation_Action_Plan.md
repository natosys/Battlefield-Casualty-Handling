...
| 339 | Re-screen the two dwell responses after the censored-interval correction | Medium | High | Open |
...
### Phase 2 — Model Fidelity (Issues 8 ✓, 35 ✓, 37 ✓, 44 ✓, 6 ✓, 5 ✓, 43 ✓, 14 ✓, 73 ✓, 74 ✓, 85 ✓, 76 ✓, 161 ✓, 156 ✓, 159 ✓, 173 ✓, 180 ✓, 178 ✓, 146 ✓, 313 ✓, 365 ✓, 376 ✓)
...
UNBLOCKED (start now):
  ...
  #339 Re-screen r2b_dwell_mean and r2e_dwell_mean at the corrected response
       definition. The tracked rankings cannot be re-derived, the cache
       holding scalar responses rather than the monitoring data behind them,
       so this is a full screen of roughly nineteen hours. Raised from #331;
       consider evaluating one design covering #335's screening question too.
