...
| 295 | Replicated analysis of national support base demand and strategic evacuation reliability | High | Medium | Open |
...
UNBLOCKED (start now):
  #312 The sustained-operations horizon, partially advanced by PR #347 and
       ...
       warm-up re-derivation and the horizon audit are done; the airlift
       sweep entry point belongs to #295 and a re-screen at length is
       unscoped, so this stays here rather than moving to COMPLETE.
  #295 Replicated analysis of national support base demand and strategic
       evacuation reliability. PR #354 gives it the reducing long-horizon
       runner and its CLI, which the sweep entry point can be built on and
       which was the part of it #312 was carrying.
