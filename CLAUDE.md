...
| Role 4 demand (seed 42) | 193 strategic evacuation decisions (125 critical route, 68 standard); all 193 boarded and reached Role 4 by day 30, none left queued at R2E; Role 4 peak occupancy 120.0 concurrent patients on day 30, the campaign's last day, decaying below one around day 68 |
| Role 4 bed composition (seed 42) | 906 intensive care bed-days (25.4%) and 2,660 holding bed-days (74.6%), reported in the bed types the deployed echelons field. A casualty admitted to intensive care is served the requirement theatre did not, a mean of 7.1 days here against the 7.6 the calibrating source reports, then steps down to a holding bed. The peak and the total bed-days are unaffected by the split, both being properties of arrivals and stay length rather than of bed type. No `resus` demand is reported, the model giving Role 4 no reception episode, and no `ot` demand arises at the shipped configuration, every definitive repair being completed in theatre before evacuation. A casualty released with the repair outstanding carries it rearward as reported theatre demand in operations and theatre-minutes, conserved from the draw the releasing theatre took; that population is empty here, the release shipping disabled (README Further Development L33) |
