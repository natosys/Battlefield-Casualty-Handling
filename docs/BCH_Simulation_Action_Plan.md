...
| 112 | Verify sensitivity screening covers all relevant model parameters | Medium | Medium | **Merged (PR #135)** |
...
**Merged:** PR #135, branch `claude/issue-112-3jvy9y`
...
**Unblocked by this merge:** No new issues unblocked — no open issue lists Issue #112 as a dependency, and no issue in the repository currently carries `status: blocked`.
...
24. ~~**Issue 112** — Verify Morris sensitivity screening covers all relevant `env_data.json` parameters: audit the full parameter surface, add missing parameters with cited bounds, document exclusion rationale for the remainder, and re-run the screening.~~ — **Merged PR #135.**
...
COMPLETE (merged to main):
  ...
  #112 Sensitivity screening parameter-surface audit — cross-referenced
       ...
       Name Reference" subsection (PR #135)
