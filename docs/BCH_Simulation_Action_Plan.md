...
| 312 | The 30-day experimental horizon cannot surface constraints that develop over months | High | High | Open — partially advanced (PR #319, PR #347, PR #354) |
...
UNBLOCKED (start now):
  #312 The sustained-operations horizon, partially advanced by PR #347 and
       PR #354. The protocol, its measurement, the duration pilot, the
       warm-up re-derivation and the horizon audit are done. Two items
       remain: an entry point that re-executes the 360-day airlift collapse
       experiment, which PR #356 narrowed but did not close, its sweep being
       at a 30-day horizon and reporting means rather than the collapse
       classification; and scoping whether a sensitivity re-screen at length
       is warranted, which sits with #348, #339 and #335.
