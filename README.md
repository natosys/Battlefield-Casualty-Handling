...
The share retained in theatre is an output rather than an input. At the shipped configuration it runs at 27.6% across 50 replications, with a 95% confidence interval of 26.1% to 29.1% over some 158 dispositions per run, inside the 7.6% to 42.1% range of historical in-theatre return-to-duty rates recorded in [[9]](#references).
