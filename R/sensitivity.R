...
#'   current baseline; see README Sensitivity Analysis section for
#'   derivation.
morris_params <- data.frame(
  ...
  lower = c(90,    25,    0.0115, 15,   15,   770,   0.70,  0.05,  8),
  upper = c(150,   70,    0.046,  45,   45,   2160,  0.98,  0.20,  16),
  mode  = c(120,   45,    0.023,  30,   30,   1440,  0.90,  0.10,  12),
