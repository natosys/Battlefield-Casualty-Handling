...
**ICU is the primary binding constraint at the R2E Heavy.** Mean ICU utilisation across all four beds is **68.4%** (seed 42, 30 days) — per-bed rates of 78.0%, 73.6%, 63.7%, and 58.1% — compared with 33.9% mean OT utilisation. The ICU queue is non-zero for **11.5 cumulative days** out of 30 (38% of the run), reaches a maximum of five patients waiting, and sustains a queue of three or more for 3.5 days and five for 0.6 days. These are not isolated transient surges: the ICU operates under chronic demand pressure. By contrast, the OT queue reaches three or more for only 0.5 cumulative days. With R2E now processing 122 surgical cases, the post-surgical ICU requirement has risen commensurately; under the current four-bed establishment the ICU constitutes the single greatest throughput constraint in the R2E system.
