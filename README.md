...
> **Uncertainty:** Low for the mean-invariance property itself; Medium for the specific choice of `cap_multiplier = 3` and for the un-derived `cap = 5` absolute value retained by `make_ln_arrival_generator()`.
