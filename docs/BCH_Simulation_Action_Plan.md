...
| 313 | Review the R2E holding establishment and evacuation policy defaults | High | Medium | Open — partially advanced (PR #360) |
...
COMPLETE (merged to main):
  ...
  #295 Strategic evacuation and Role 4 demand are measured at 50 replications
       ...
       evacuation wait holds a bed on the standard route alone, and demand
       peaks 1.36 days before the campaign ends rather than after (PR #356)
...
UNBLOCKED (start now):
  ...
  #313 The evacuation policy and R2E holding establishment defaults,
       partially advanced by PR #360. The policy sweep is done and supports
       the shipped 21-day value as the only setting in the doctrinal range
       that is both admissible against the historical in-theatre envelope and
       stable at length. Three items remain: the holding establishment sweep,
       establishment and policy being substitutes whose relative price is
       unmeasured (README Further Development L32); the missing duration
       attribute on the post-operative damage control hold arm; and any
       further decision on the default.
