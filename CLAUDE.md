...
|---|---|
| Total casualties (30 days) | 382 (post-Issue-148; was 386 post-Issue-173, 385 post-Issue-159, 386 post-Issue-160, 387 post-Issue-161, 400 pre-Issue-18) |
| WIA (combat + support) | 151 (post-Issue-148; was 149 post-Issue-173, 148 post-Issue-159, 149 post-Issue-160, 150 post-Issue-161, 154 pre-Issue-18). Rises because the mean-relative cap is looser on the WIA streams than the fixed cap of 5 was |
| KIA (combat + support) | 57 (post-Issue-148; was 67 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 70 pre-Issue-18). The largest single-stream movement of this refresh: the retired fixed cap of 5 sat at 7.4 times the KIA streams' own mean of 0.68 and so barely bound them, where the mean-relative cap binds them as it binds every other stream |
| DNBI (combat + support) | 174 (post-Issue-148; was 170 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 176 pre-Issue-18) |
| Effective force size, end of run (seed 42, post-Issue-173) | combat: 2332 of 2500 initial (−6.7%); support: 1185 of 1250 initial (−5.2%); no reinforcement (`force_regeneration.reinforcement.demand_interval_days = 0`, the shipped default). Was combat 2334 / support 1179 post-Issue-173 |
...
| Priority 1 share (seed 42, post-Issue-148) | 206 of 382 classified (53.9%) — P1 206 / P2 67 / P3 52 / KIA 57; was P1 195 / P2 67 / P3 57 / KIA 67 post-Issue-173. Every generated casualty carries an assigned priority in this run |
| DOW count (seed 42, post-Issue-148) | 0 total: r2b=0, r2e_postop=0, ame_wait=0; was 1 (r2b=1) post-Issue-173. At n≤3 a change of one carries no statistical weight; see the pooled multi-replication row below for the figure that does |
...
| Mean DOW/run (150 reps pooled, post-Issue-189) | 0.85; 95% CI [0.69, 1.01]. DOW/WIA rate 0.568% (95% CI [0.461%, 0.675%]); treated-cohort DOW rate (casualties reaching R2B or R2E) 0.38% (95% CI [0.31%, 0.45%]), the quantity the historical Ajax Bay target of ~0.46% applies to, and an interval that now sits below it rather than spanning it. Since the target is an upper bound the check is one-sided, so sitting below is agreement, and `p1_p_max`/`p2_p_max` are unchanged in both configurations. Pooled across three independent 50-replication measurements, at control seeds 42, 777 and 20260808, because one measurement does not resolve a response averaging under one death per replication: individually those three returned treated-cohort rates of 0.387%, 0.327% and 0.418%, a spread of 0.092 percentage points. The superseded row read 0.95 (95% CI [0.79, 1.10]) with a treated-cohort rate of 0.416% (95% CI [0.346%, 0.485%]); the movement is sampling variation between two sets of control-seed draws, not an effect of Issue #189, whose fix leaves every point estimate unbiased, and the two intervals overlap across most of their length. What Issue #189 changes is that this interval is now correctly specified, the replications behind it being independent rather than antithetically paired. Precision: the per-replication standard deviation is 0.0044, so 150 replications resolve the treated-cohort rate to about ±0.07 percentage points and no third decimal place is reported. See README Further Development L22 |
| Replication count for mortality figures (post-Issue-189) | Per-replication sd of the treated-cohort DOW rate is 0.0044 (base, 150 reps). A 95% half-width of 0.15 pp needs 33 replications, 0.10 pp needs 73, 0.05 pp needs 292. The 50-replication figures elsewhere in this table carry roughly ±0.12 pp on this response; the queue and occupancy rows are time-weighted over far more events per replication and are better resolved at the same count |
| DNBI sub-types (seed 42, post-Issue-148) | battle_fatigue=43, disease=101, nbi=30 (post-Issue-148; was battle_fatigue=43, disease=101, nbi=26 post-Issue-173) — RNG-stream-shifted despite DNBI sub-type assignment itself being unrelated code, per the single-global-RNG-stream mechanism (see provenance caveat above) |
| bf_rtd (seed 42, post-Issue-148) | 40 (post-Issue-148, unchanged from post-Issue-173; was 48 post-Issue-159) |
| clinical_rtd (seed 42, post-Issue-148) | 109 (r1: 58, r2b: 39, r2e: 12) (post-Issue-148; the total is unchanged from post-Issue-173 but its echelon split moves, which was 55 / 42 / 12) |
| total_rtd (seed 42, post-Issue-148) | 149 (post-Issue-148, unchanged from post-Issue-173; was 134 post-Issue-159) |
| Realised in-theatre share (seed 42, post-Issue-148) | 36.7% of 139 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input. Was 32.4% of 139 dispositions post-Issue-173. The 50-replication figure was not recomputed for Issue #148 and remains 26.8% (95% CI [25.5%, 28.0%]), inside the 7.6%-42.1% historical range cited in README Return to Duty |
| Evacuation is severity-conditioned (seed 42, post-Issue-148) | Sorting the 139 dispositions into quartiles by drawn `recovery_to_duty_days` gives evacuation rates of 0% / 54.3% / 100% / 100% from shortest to longest recovery; was 0% / 71.4% / 100% / 100% post-Issue-173. An unconditioned draw would give the same rate in every quartile. The 50-replication figure was not recomputed and remains 0.0% / 93.5% / 100% / 100% |
| Pre-flight critical ICU hold (seed 42, post-Issue-148) | 10 of 56 critical-route evacuees drew the ventilated pre-flight path (`critical_hold.ventilated_share = 0.15`); 5 completed within the run at a mean of 24.1 h, median 21.3 h, p90 31 h. Was 10 of 56 with 8 completed at a mean of 23.7 h post-Issue-173. The 50-replication figures were not recomputed and remain 31.9 h mean, 24.3 h median, 32 h p90 as last measured post-Issue-160 |
...
| Surgical pathway split (seed 42, post-Issue-148) | 115 casualties operated on: 66 damage control (57.4%), 49 single-stage. By priority, Priority 1 91 operated / 62 damage control (68.1%, configured rate 55%), Priority 2 24 operated / 4 damage control (16.7%, configured 20%); no Priority 3 casualty reached theatre in this run. Was 113 operated, 56 damage control (49.6%) post-Issue-173; a single run of about a hundred draws sits this far from its configured rate routinely. The 50-replication share was not recomputed and remains 48.3% (95% CI [47.0%, 49.5%]) |
...
| R2B surgical decision point (seed 42, post-Issue-148) | 118 casualties reached it (54 operated at R2B, 64 bypassed to R2E); was 113 (50 operated, 63 bypassed) post-Issue-173 |
| R2B surgeries (seed 42, post-Issue-148) | 54 (post-Issue-148; was 50 post-Issue-173) |
| R2E surgeries — first op (seed 42, post-Issue-148) | 98 (post-Issue-148; was 87 post-Issue-173), tracking the rise in WIA volume |
| R2E surgeries — second op (seed 42, post-Issue-148) | 21 (post-Issue-148; was 22 post-Issue-173). Only a damage control casualty whose abbreviated operation was performed at R2E returns for a second procedure, so this stays at roughly the damage control share of casualties not operated on forward |
| R2B pre-transport bypass (seed 42, post-Issue-148) | upstream R1-threshold bypass: 118 (was 114 post-Issue-173); at-R2B hold-full bypass: 0 (unchanged); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-148) | at-R2B subset, 64 total (was 63 post-Issue-173): team off-shift 59 (was 55), OT busy/queued 5 (was 8) |
| OT utilisation — echelon aggregate (seed 42, post-Issue-148) | R2B: 5.8%, R2E: 10.8% (was R2B: 5.0%, R2E: 12.0% post-Issue-173). Forward theatre load rises and rear falls, more casualties being operated on at R2B |
| R2B OT utilisation — 24h room (seed 42, post-Issue-148) | T1: 7.3%, T2: 6.7% (was T1: 7.7%, T2: 5.9% post-Issue-173) |
| R2B OT utilisation — shift time (seed 42, post-Issue-148) | T1: 14.5%, T2: 13.4% — the team being rostered 12 hours of every 24, this runs at twice the 24-hour room figure above. Was T1: 15.4%, T2: 11.8% post-Issue-173 |
| R2E OT utilisation — 24h room (seed 42, post-Issue-148) | OT1: 25.2%, OT2: 8.4% (was OT1: 29.6%, OT2: 13.7% post-Issue-173). A theatre is seized before its surgical section, so a room reads as occupied while its casualty is still queued for staff; much of this is that wait, not operating time |
| R2E OT queue ≥1 (seed 42, post-Issue-148) | OT1: 1.1% of run, OT2: 0% (was OT1: 5.7%, OT2: 3.9% post-Issue-173) |
| R2E surgical section utilisation (seed 42, post-Issue-148) | Section 1: 15.4%, Section 2: 29.7%, Section 3: 18.0% of rostered time, queued for 0%, 3.98% and 0.14% of it (was 14.7/30.3/14.2% utilisation queued 2.16/15.04/3.81% post-Issue-173). Section 2 remains the busiest, being the section rostered to the second shift and so carrying the whole night-time surgical load alone |
| R2E ICU utilisation — mean (seed 42, post-Issue-148) | ICU1: 91.7%, ICU2: 92.7%, ICU3: 88.4%, ICU4: 85.4% (was ICU1: 93.3%, ICU2: 88.4%, ICU3: 83.6%, ICU4: 73.0% post-Issue-173). Demand spreads further down the bed order, the fourth bed rising more than twelve points. The 50-replication figure was not recomputed for Issue #148 and remains a four-bed mean of 79.7% (95% CI [78.4%, 81.0%]), computed by the project's own `utilisation_per_replication()` (R/analysis.R) |
| R2E ICU queue ≥1 (seed 42, post-Issue-148) | ICU1: 44.6% of run, ICU2: 33.7%, ICU3: 23.0%, ICU4: 0% (was ICU1: 44.9%, ICU2: 8.8%, ICU3: 1.6%, ICU4: 0% post-Issue-173). Intensive care queues deeper into the bed order than at any previously documented configuration |
| Transport utilisation — platform aggregate (seed 42, post-Issue-148) | HX240M: 4.1%, PMVAmb: 10.3% (was HX240M: 4.7%, PMVAmb: 10.0% post-Issue-173). Mortuary road-move traffic falls with the KIA count |
| PMV Ambulance utilisation (seed 42, post-Issue-148) | 10.3%; max queue 0 throughout run; per-vehicle 24.9% / 5.4% / 0.5% (was 23.3% / 6.2% / 0.5% post-Issue-173) |
| HX240M utilisation (seed 42, post-Issue-148) | 4.1%; max queue 0 throughout run; per-vehicle 7.7% / 0.6% (was 9.3% / 0.2% post-Issue-173) — carries R2B→R2E mortuary road-move traffic in addition to R1→mortuary KIA |
...
| R2E post-op pathway — stabilisation (seed 42, post-Issue-148) | icu=37, hold=49 (post-Issue-148; was icu=45, hold=34 post-Issue-173). The degraded share rises from 43% to 57%, the stabilisation cohort having grown with the damage control count while the four intensive care beds did not. `surgery_deferred` = 17 (was 12 post-Issue-173); the 50-replication figure was not recomputed and remains 10.1 (95% CI [9.2, 11.1]) |
| R2E post-definitive care pathway (seed 42, post-Issue-148) | icu=44, hold=56 — 44% of operated casualties receive post-definitive care in an ICU bed, against 55% post-Issue-173, the remainder taking the degraded holding-bed fallback. The 50-replication ICU share was not recomputed and remains 48.6% (95% CI [47.0%, 50.1%]). Four ICU beds still cannot cover both episodes for everyone, and the shortfall widens with the larger damage control cohort |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-148) | 0/37 vs 0/49 (single-run; was 0/45 vs 0/34 post-Issue-173). The saturated-ICU 90-day stress test from Issue #43, which confirmed the mechanism fires with the hold pathway riskier than the icu pathway, has not been re-run since |
| Role 4 demand (seed 42, post-Issue-148) | 88 strategic evacuation decisions; 67 boarded and reached Role 4 by day 30, 21 still queued at R2E; Role 4 peak occupancy 49.0 concurrent patients (day 17); unconstrained-baseline demand would need 26 sorties. Was 94 decisions, 75 boarded, 19 queued, peak 49.0 on day 18, 28 sorties post-Issue-173. Demand falls with the higher in-theatre retention share |
| Strategic AME actual performance (seed 42, post-Issue-148) | C-17A Globemaster III at 36 critical / 54 standard places; 67 evacuated at a mean wait of 0.9 days (p10-p90 0.0-3.0). Was 75 evacuated at a mean wait of 1.3 days post-Issue-173 |
| AME wait-time DOW poll (seed 42, post-Issue-148) | `dow_echelon=5`, daily poll interval (`role4.ame.dow_check_interval = 1440` min); 0 deaths observed, as in every run since the poll was added; see README [AME Wait Checkpoint](README.md#ame-wait-checkpoint) for why no single-run count should be read as evidence about the mechanism's magnitude |
