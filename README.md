...
Three aircraft ship, all from the RAAF's account of its aeromedical evacuation capability [[62]](#references), which reports that an AME-configured C-17A "can transport 54 ambulatory and 36 high dependency stretcher patients" and that "the C-130J and C-27J can carry 97 and 21 stretcher patients respectively":
...
| L33 | Definitive repair is always performed in theatre, so Role 4 surgical and intensive care demand is understated | Medium |
...
**L33 — Definitive repair is always performed in theatre, so Role 4 surgical and intensive care demand is understated.** A casualty on the damage control pathway receives the abbreviated operation, a period of stabilisation intensive care, the definitive repair and the intensive care following it, and the model performs every one of those steps before the casualty becomes eligible for strategic evacuation: the disposition that releases a casualty to a sortie is the last phase of the R2E trajectory, after the second operation and after post-definitive care. A theatre under evacuation pressure would not always work that way. Moving a casualty rearward between the abbreviated operation and the definitive repair is a recognised option, and where it is taken the repair and the intensive care after it both fall to the national support base rather than to the deployed hospital. Three consequences follow, all in the same direction. Role 4 surgical and intensive care demand is understated, and understated for the most severely injured cohort specifically. Theatre demand is correspondingly overstated, R2E performing second operations and holding intensive care beds for recoveries a real theatre might have sent rearward, which flows into every forward utilisation and queue figure the project reports. And the gap is coupled to the evacuation policy rather than independent of it, since a shorter policy would move more of this work rearward, so the policy comparison reported in the replicated analysis understates what shortening the threshold asks of the national support base. Closing this means making the second operation conditional on a disposition taken before it rather than after, which is a change to the trajectory and so to the random number stream, and it needs a rule for which casualties are eligible to travel between the two operations.
...
[59] Inwald, D. P., Arul, G. S., Montgomery, M., Henning, J., McNicholas, J., & Bree, S. (2013). Management of children in the deployed intensive care unit at Camp Bastion, Afghanistan. *Journal of the Royal Army Medical Corps*, *160*(3), 236–240. Retrieved 02 Aug 26, from https://pmc.ncbi.nlm.nih.gov/articles/PMC4154587/

[60] U.S. Army Medical Department Center and School. *Health Service Support in a Theater of Operations*, Subcourse MD0002, Evacuation Policy. Retrieved 02 Aug 26, from http://armymedical.tpub.com/MD0002/Evacuation-Policy-Health-Service-Support-in-a-Theater-of-Operations-88.htm

[61] Johnston, A. M., Henning, J., & Harrison, D. (2014). Outcomes of military patients treated at the UK Royal Centre for Defence Medicine 2007 to 2013. *Critical Care*, *18*(Suppl 1), P57. Retrieved 16 Sep 26, from https://pmc.ncbi.nlm.nih.gov/articles/PMC4068646/

[62] Royal Australian Air Force. *Aeromedical evacuation*. Australian Government, Department of Defence. Retrieved 02 Aug 26, from https://www.airforce.gov.au/our-work/humanitarian-support/aeromedical-evacuation

[63] U.S. Air Force. *C-130 Hercules*. Air Force Fact Sheet. Retrieved 02 Aug 26, from https://www.af.mil/About-Us/Fact-Sheets/Display/Article/1555054/c-130-hercules

[64] Goel, M. K., Khanna, P., & Kishore, J. (2010). Understanding survival analysis: Kaplan-Meier estimate. *International Journal of Ayurveda Research*, *1*(4), 274-278. Retrieved 11 Sep 26, from https://pmc.ncbi.nlm.nih.gov/articles/PMC3059453/

[65] Royston, P., & Parmar, M. K. B. (2013). Restricted mean survival time: an alternative to the hazard ratio for the design and analysis of randomized trials with a time-to-event outcome. *BMC Medical Research Methodology*, *13*, 152. Retrieved 11 Sep 26, from https://pmc.ncbi.nlm.nih.gov/articles/PMC3922847/

[66] Hall, A., Graham, B., Hanson, M., & Stern, C. (2023). Surgical capability utilization time for military casualties at role 2 and role 3 facilities. *Military Medicine*, *188*(11-12), e3368-e3370. Retrieved 10 Aug 26, from https://academic.oup.com/milmed/article/188/11-12/e3368/6961509
