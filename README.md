...
| ----------------------- | ---------------------------------- | ------------------------------------------------------------------ |
| Treated-cohort DOW rate | 0.290% (95% CI [0.240%, 0.340%])   | ≤0.46% (3 deaths among over 650 reaching forward surgery [[14]](#references)) |
