...
| 240 | Bring the multi-run analysis paper to publication standard | High | High | Open |
...
3. **Issue 240** (ready) — Bring `docs/Multi_Run_Analysis.md` to publication standard: complete the statistical specification and remove the supersession narrative, and settle whether its title should name the wider scope PR #280 gave it. Requires Issues 238 and 230.
...
UNBLOCKED (start now):
  #228 Higher-resolution Sobol decomposition — N ~ 800 at 8 to 12 replications
       ...
       merge of #226.
  #240 Multi-run analysis paper to publication standard. Unblocked by the
       same two merges, and now additionally carries the question of whether
       the document's title should name the wider scope #238 gave it.
