...
| Role 4 ward composition (seed 42) | 906 intensive care bed-days (25.4%), 2,079 surgical ward (58.3%) and 581 general ward (16.3%). A casualty admitted to intensive care is served the requirement theatre did not, a mean of 7.1 days here against the 7.6 the calibrating source reports, then steps down to a surgical ward. The peak and the total bed-days are unaffected by the split, both being properties of arrivals and stay length rather than of ward |
