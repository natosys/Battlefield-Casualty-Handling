...
| 335 | Sweep R2B holding capacity against the evacuation threshold | Medium | Medium | Open |
...
### Phase 7 — Publication (Issues 238 ✓, 239 ✓, 240 ✓, 311 ✓, 315 ✓, 327 ✓, 333 ✓)
...
UNBLOCKED (start now):
  #312 The sustained-operations horizon, partially advanced by PR #347,
       ...
       sits with #348, #339 and #335; and the warm-up classification at that
       horizon, which rests on the block means alone.
  #335 Joint sweep of R2B holding capacity against the evacuation threshold,
       and the decision on whether that threshold joins the Morris screen.
       Unblocked by the merge of #333, which gives the threshold a
       configuration entry and so a way to sweep it.
  #339 Re-screen r2b_dwell_mean, r2e_dwell_mean, ame_backlog_mean and
       ...
       issue's own question in favour of re-screening the whole set; consider
       evaluating one design covering #335's screening question too.
  #348 The Morris screen has no holding bed queue response and never varies
       ...
       remaining coverage gaps against #335 and #339 is the substance: a
       response added to a re-screen that is happening anyway is nearly
       free. Raised from the #312 audit.
