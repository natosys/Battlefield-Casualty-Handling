...
| 239 | Bring the single-run analysis paper to publication standard | High | High | Open |
...
2. **Issue 239** (ready) — Bring `docs/Single_Run_Analysis.md` to publication standard: remove the twenty-two issue-number references and three blockquoted maintainer notes, add a methods section and a limitations section cross-referencing the README's `L` entries, verify every numeric claim against the current baseline, and clear the presentation defects. Requires Issues 238 and 230.
...
UNBLOCKED (start now):
  #228 Higher-resolution Sobol decomposition — N ~ 800 at 8 to 12 replications
       ...
       merge of #226.
  #239 Single-run analysis paper to publication standard. Unblocked by the
       merge of #238, which settled what the document contains; #230, its
       other gate, merged as PR #243.
