...
| ------------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| R1 TCCC                                           | 1.0              | TCCC is a post-1990s doctrine [[29]](#references). The 1945 battalion aid man carried morphine, sulfanilamide and dried plasma, none of which reaches the non-compressible haemorrhage that dominates potentially preventable death, so no ceiling reduction is attributed to this checkpoint.  |
| R2B / R2E resuscitation                           | 0.95             | Resuscitation was plasma-led, and plasma restores circulating volume without oxygen-carrying capacity. Whole blood reached the Pacific in quantity only late in the war, the Okinawa plan forecasting one pint per casualty against one pint per three casualties in 1943 [[66]](#references). |
...
The calibration target is Okinawa's own died-of-wounds rate: the US Army on Okinawa reported that 3.4% of casualties who reached a hospital alive subsequently died there, against a World War II average of 4.5% [[66]](#references), and an independent recalculation of the war's aggregate figure on a consistent denominator gives 3.5% [[11]](#references). That denominator is the population reaching a treatment facility, which is the cohort the Ajax Bay target measures and the cohort the model reports, so each profile is compared against its own campaign on a like basis. Unlike the Ajax Bay figure, this one is a reported rate against a stated denominator rather than a bound derived from an inexact one, so the model is calibrated to reach it rather than only to stay beneath it.
...
| ----------------------- | ---------------------------------- | ------------------------------------------------------------------------- |
| Treated-cohort DOW rate | 3.471% (95% CI [3.360%, 3.583%])   | 3.4% (US Army, Okinawa [[66]](#references))                               |
...
[66] Marble, S. (2025). Both joint and not: Medical support at Okinawa, 1945. *Joint Force Quarterly*, *117*(2), article 11. National Defense University Press. Retrieved 17 Aug 26, from https://digitalcommons.ndu.edu/joint-force-quarterly/vol117/iss2/11/

[67] Puy, A., Becker, W., Lo Piano, S., & Saltelli, A. (2022). A comprehensive comparison of total-order estimators for global sensitivity analysis. *International Journal for Uncertainty Quantification*, *12*(2), 1-18. arXiv preprint. Retrieved 22 Aug 26, from https://arxiv.org/abs/2009.01147
