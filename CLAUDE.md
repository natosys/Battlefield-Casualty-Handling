...
|---|---|
| Total casualties (30 days) | 437 (post-Issue-203; was 382 post-Issue-148 and post-Issue-146, 386 post-Issue-173, 385 post-Issue-159, 386 post-Issue-160, 387 post-Issue-161, 400 pre-Issue-18). The rise is the rate cap's shortfall removed, not a change in any configured rate |
| WIA (combat + support) | 187 (post-Issue-203; combat 124 / support 63; was 151 post-Issue-148 and post-Issue-146, 149 post-Issue-173, 148 post-Issue-159, 149 post-Issue-160, 150 post-Issue-161, 154 pre-Issue-18). The WIA streams had been realising 79.0% of their configured mean, the largest shortfall of any shipped stream alongside KIA |
| KIA (combat + support) | 71 (post-Issue-203; combat 47 / support 24; was 57 post-Issue-148 and post-Issue-146, 67 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 70 pre-Issue-18). The KIA streams had been realising 78.7% of their configured mean |
| DNBI (combat + support) | 179 (post-Issue-203; combat 145 / support 34; was 174 post-Issue-148 and post-Issue-146, 170 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 176 pre-Issue-18). Moves least of the three, the DNBI streams being the least variable and so the least clamped, at 95.2% and 99.2% of their configured means |
| Effective force size, end of run (seed 42, post-Issue-203) | combat: 2300 of 2500 initial (−8.0%); support: 1162 of 1250 initial (−7.0%); no reinforcement (`force_regeneration.reinforcement.demand_interval_days = 0`, the shipped default). Was combat 2330 / support 1184 post-Issue-146 |
...
| Priority 1 share (seed 42, post-Issue-203) | 229 of 437 classified (52.4%) — P1 229 / P2 85 / P3 52 / KIA 71; was P1 219 / P2 50 / P3 56 / KIA 57 post-Issue-146. Every generated casualty carries an assigned priority in this run |
| DOW count (seed 42, post-Issue-203) | 1 total (r2b=1), unchanged from post-Issue-146. At n≤3 a change of one carries no statistical weight; see the pooled multi-replication row below for the figure that does |
...
| Mean DOW/run (150 reps pooled, post-Issue-208) | Treated-cohort DOW rate (casualties reaching R2B or R2E) 0.417% (95% CI [0.354%, 0.480%]) at the re-fitted ceilings, pooled across three independent 50-replication measurements; the three returned 0.524%, 0.359% and 0.368% individually. This is the quantity the historical Ajax Bay bound of ~0.46% applies to, and the interval sits at it. `moderate_intensity` measures 0.353% (95% CI [0.293%, 0.413%]); it overrides both ceilings, so the Issue #203 re-fit left it as the control on that change. The two intervals overlap, so 150 replications separate each profile from the bound but not the profiles from each other. `scripts/check_dow_calibration.R` passes for both. The pre-re-fit configuration overshot: 0.528% (95% CI [0.460%, 0.595%]) at 150 replications and 0.513% ([0.462%, 0.564%]) at 250, an overshoot that survived the larger pool rather than dissolving into it, which is what warranted the re-fit. DOW/WIA rate is not pooled at 150 replications, the calibration check not reporting it; the 50-replication comparative measurement puts `moderate_intensity` at 0.55% (95% CI [0.40%, 0.69%]) and `high_intensity` at 0.79% ([0.68%, 0.90%]). See README Further Development L22 |
| Replication count for mortality figures (post-Issue-208) | Per-replication sd of the treated-cohort DOW rate is 0.0039 (base, 150 reps at the re-fitted ceilings). A 95% half-width of 0.15 pp needs 29 replications, 0.10 pp needs 62, 0.05 pp needs 237. The 50-replication figures elsewhere in this table carry roughly ±0.11 pp on this response; the queue and occupancy rows are time-weighted over far more events per replication and are better resolved at the same count. Single 50-replication measurements of the same configuration span 0.165 pp across control seeds, which is why the calibration pools three |
| DNBI sub-types (seed 42, post-Issue-203) | battle_fatigue=42, disease=108, nbi=29 (post-Issue-203; was battle_fatigue=38, disease=105, nbi=34 post-Issue-146) — the total rises with DNBI generation, and the split between sub-types moves with the RNG stream despite sub-type assignment itself being unrelated code |
| bf_rtd (seed 42, post-Issue-203) | 41 (post-Issue-203; was 32 post-Issue-146), tracking the rise in the battle fatigue sub-type count above |
| clinical_rtd (seed 42, post-Issue-203) | 108 (r1: 52, r2b: 41, r2e: 15) (post-Issue-203; was 114, split 65 / 39 / 10, post-Issue-146) |
| total_rtd (seed 42, post-Issue-203) | 149 (post-Issue-203; was 146 post-Issue-146). As a share of arrivals this falls, 38.2% to 34.1%, the larger casualty count including more casualties whose recovery extends past the 30-day window |
| Realised in-theatre share (seed 42, post-Issue-203) | 26.8% of 179 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input. Was 24.5% of 151 dispositions post-Issue-146; the share is close to unmoved while the count rises with generation, which is what a policy applied to an unchanged severity mix should do. The 50-replication figure was not recomputed for Issue #203 and remains 26.8% (95% CI [25.5%, 28.0%]), inside the 7.6%-42.1% historical range cited in README Return to Duty |
| Evacuation is severity-conditioned (seed 42, post-Issue-203) | Sorting the 179 dispositions into quartiles by drawn `recovery_to_duty_days` gives evacuation rates of 0% / 93.3% / 100% / 100% from shortest to longest recovery; was 2.6% / 100% / 100% / 100% post-Issue-146. An unconditioned draw would give the same rate in every quartile. The 50-replication figure was not recomputed and remains 0.0% / 93.5% / 100% / 100% |
| Pre-flight critical ICU hold (seed 42, post-Issue-203) | 12 critical-route evacuees drew the ventilated pre-flight path (`critical_hold.ventilated_share = 0.15`); 11 completed within the run at a mean of 28.0 h, median 25.4 h, p90 39 h. Was 15 with 8 completed at a mean of 25.0 h post-Issue-146. The 50-replication figures were not recomputed and remain 31.9 h mean, 24.3 h median, 32 h p90 as last measured post-Issue-160 |
...
| Surgical pathway split (seed 42, post-Issue-203) | 155 casualties operated on: 72 damage control (46.5%), 83 single-stage. By priority, Priority 1 117 operated / 62 damage control (53.0%, configured rate 55%), Priority 2 38 operated / 10 damage control (26.3%, configured 20%); no Priority 3 casualty reached theatre in this run. Was 120 operated, 66 damage control (55.0%) post-Issue-146. The 50-replication share was not recomputed and remains 48.3% (95% CI [47.0%, 49.5%]) |
...
| R2B surgical decision point (seed 42, post-Issue-203) | 152 casualties reached it (74 operated at R2B, 78 bypassed to R2E); was 118 (49 operated, 69 bypassed) post-Issue-146 |
| R2B surgeries (seed 42, post-Issue-203) | 74 (post-Issue-203; was 49 post-Issue-146) |
| R2E surgeries — first op (seed 42, post-Issue-203) | 115 (post-Issue-203; was 96 post-Issue-146) |
| R2E surgeries — second op (seed 42, post-Issue-203) | 31 (post-Issue-203; was 38 post-Issue-146). Only a damage control casualty whose abbreviated operation was performed at R2E returns for a second procedure, so this stays at roughly the damage control share of casualties not operated on forward |
| R2B pre-transport bypass (seed 42, post-Issue-203) | upstream R1-threshold bypass: 135 (was 118 post-Issue-146); at-R2B hold-full bypass: 1 (was 0); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-203) | at-R2B subset, 78 total (was 69 post-Issue-146): team off-shift 58 (was 53), OT busy/queued 20 (was 16). The off-shift share falls from 77% to 74% as the larger caseload presses harder on the single forward theatre |
| R2B pre-open hold (seed 42, post-Issue-203) | 10 casualties held forward for a section about to reopen, all 10 operated on within the run, mean hold 22.4 minutes, longest 44.3, against the shipped 60-minute `r2b.surgery.pre_open_window_min`. Was 7 held at a mean of 40.9 minutes post-Issue-146. The 50-replication figure was not recomputed and remains 5.6 held per run (95% CI [5.0, 6.3]) |
| OT utilisation — echelon aggregate (seed 42, post-Issue-203) | R2B: 6.1%, R2E: 11.4% (was R2B: 4.9%, R2E: 15.6% post-Issue-146) |
| R2B OT utilisation — 24h room (seed 42, post-Issue-203) | T1: 8.3%, T2: 11.3% (was T1: 7.6%, T2: 6.2% post-Issue-146). The 50-replication figures were not recomputed for Issue #203 |
| R2B OT utilisation — shift time (seed 42, post-Issue-203) | T1: 16.6%, T2: 22.5% — theatre occupancy measured against the section's own rostered capacity trace. Was T1: 15.1%, T2: 12.3% pre-Issue-203 on the same basis; the previously published 13.9%/11.9% used a basis that could not be reconstructed and ran about 8% lower. This does not run at exactly twice the 24-hour room figure above: the pre-open hold occupies the theatre while the section is off shift, so some of the room's occupancy falls outside the roster this row divides by |
| R2E OT utilisation — 24h room (seed 42, post-Issue-203) | OT1: 30.9%, OT2: 15.4% (was OT1: 41.6%, OT2: 22.6% post-Issue-146). A theatre is seized before its surgical section, so a room reads as occupied while its casualty is still queued for staff; much of this is that wait, not operating time. Both fall despite a larger caseload, more of it having been operated on forward at R2B in this run |
| R2E OT queue ≥1 (seed 42, post-Issue-203) | OT1: 3.0% of run, OT2: 0.6% (was OT1: 15.9%, OT2: 10.4% post-Issue-146) |
| R2E surgical section utilisation (seed 42, post-Issue-203) | Section 1: 18.2%, Section 2: 38.9%, Section 3: 19.0% of the time their own rosters had them open, queued for 0%, 1.04% and 0% of it; the pre-change run measures 21.4/33.3/14.8 on the same basis. These are re-based onto each section's own rostered capacity trace, the previously published 19.7/31.3/13.7 having used a basis that could not be reconstructed. Section 2 remains the busiest, being the section rostered to the second shift and so carrying the whole night-time surgical load alone |
| R2E ICU utilisation — mean (seed 42, post-Issue-203) | ICU1: 97.3%, ICU2: 92.2%, ICU3: 88.1%, ICU4: 82.0% (was ICU1: 90.0%, ICU2: 86.0%, ICU3: 82.1%, ICU4: 78.9% post-Issue-146). The 50-replication figure was not recomputed for Issue #203 and remains a four-bed mean of 79.7% (95% CI [78.4%, 81.0%]) |
| R2E ICU queue ≥1 (seed 42, post-Issue-203) | ICU1: 60.9% of run, ICU2: 8.1%, ICU3: 0%, ICU4: 0% (was ICU1: 35.6%, ICU2: 16.6%, ICU3: 10.8%, ICU4: 1.2% post-Issue-146). The queue concentrates behind the first bed as the larger operated cohort presses on four beds |
| Transport utilisation — platform aggregate (seed 42, post-Issue-203) | HX240M: 5.0%, PMVAmb: 12.3% (was HX240M: 2.7%, PMVAmb: 10.2% post-Issue-146) |
| PMV Ambulance utilisation (seed 42, post-Issue-203) | 12.3%; max queue 0 throughout run; per-vehicle 28.0% / 7.9% / 1.0% (was 24.1% / 6.3% / 0.3% post-Issue-146) |
| HX240M utilisation (seed 42, post-Issue-203) | 5.0%; max queue 0 throughout run; per-vehicle 9.0% / 1.0% / 0.0% (was 7.1% / 0.7% / 0.1% post-Issue-146) — carries R2B→R2E mortuary road-move traffic in addition to R1→mortuary KIA |
...
| R2E post-op pathway — stabilisation (seed 42, post-Issue-203) | icu=47, hold=48 (post-Issue-203; was icu=44, hold=43 post-Issue-146). The degraded share is close to unmoved at 51% against 49%. `surgery_deferred` = 15 (was 7 post-Issue-146); the 50-replication figure was not recomputed |
| R2E post-definitive care pathway (seed 42, post-Issue-203) | icu=55, hold=90 — 38% of operated casualties receive post-definitive care in an ICU bed, down from 44% post-Issue-146, the remainder taking the degraded holding-bed fallback. The 50-replication ICU share was not recomputed and remains 48.6% (95% CI [47.0%, 50.1%]). Four ICU beds cover a smaller share of both episodes as generation rises to its configured rate |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-203) | 0/47 vs 0/48 (single-run; was 0/44 vs 0/43 post-Issue-146). The saturated-ICU 90-day stress test from Issue #43, which confirmed the mechanism fires with the hold pathway riskier than the icu pathway, has not been re-run since |
| Role 4 demand (seed 42, post-Issue-203) | 131 strategic evacuation decisions (77 critical route, 54 standard); 114 boarded and reached Role 4 by day 30, 17 still queued at R2E; Role 4 peak occupancy 76.0 concurrent patients (day 21); unconstrained-baseline demand would need 29 sorties. Was 114 decisions, 105 boarded, 9 queued, peak 67.0 on day 26 post-Issue-146 |
| Strategic AME actual performance (seed 42, post-Issue-203) | C-17A Globemaster III at 36 critical / 54 standard places; 114 evacuated at a mean wait of 1.1 days (p10-p90 0.0-4.0). Four sorties flew, boarding 36/24/7/2 on the critical route and 25/8/9/3 on the standard route; the first fills the critical cabin exactly. Was 105 evacuated at a mean wait of 0.7 days post-Issue-146 |
