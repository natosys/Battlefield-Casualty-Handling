...
| 376 | Both national support base levers ship disabled, so the forward theatre never sheds load | High | High | Open |
...
### Phase 2 — Model Fidelity (Issues 8 ✓, 35 ✓, 37 ✓, 44 ✓, 6 ✓, 5 ✓, 43 ✓, 14 ✓, 73 ✓, 74 ✓, 85 ✓, 76 ✓, 161 ✓, 156 ✓, 159 ✓, 173 ✓, 180 ✓, 178 ✓, 146 ✓, 313 ✓, 365 ✓)
...
UNBLOCKED (start now):
  ...
  #376 Both national support base levers ship disabled, so the forward
       theatre never sheds load and the national support base shows no
       theatre requirement. Enables the capacity release and the
       reconstruction cohort together and re-measures every replicated
       evidence set once rather than twice. The reconstruction share has its
       calibrated value already; the saturation threshold has none and is
       swept at the sustained horizon before it is set. Raised from #373.
