...
|---|---|
| Total casualties (30 days) | 385 (post-Issue-156; was 387 post-Issue-161, 386 post-Issue-23 and post-Issue-18, 400 pre-Issue-18) |
| WIA (combat + support) | 148 (post-Issue-156; was 150 post-Issue-161, 149 post-Issue-23, 154 pre-Issue-18) |
| KIA (combat + support) | 67 (post-Issue-156, unchanged from post-Issue-161 and post-Issue-23; was 70 pre-Issue-18) |
| DNBI (combat + support) | 170 (post-Issue-156, unchanged from post-Issue-161 and post-Issue-23; was 176 pre-Issue-18) |
...
| Priority 1 share (seed 42, post-Issue-156) | 202 of 385 classified (52.5%) — P1 202 / P2 72 / P3 44 / KIA 67; was P1 202 / P2 64 / P3 53 / KIA 67 post-Issue-161. Every generated casualty carries an assigned priority in this run. Not directly comparable to the pre-Issue-73-follow-up "~53.3% of 400" figure below, which predates multiple RNG-stream shifts |
...
| DOW count (seed 42, post-Issue-156) | 1 total: r2b=1, ame_wait=0; was 2 total (r2b=2, ame_wait=0) post-Issue-161. At n≤2 a change of one carries no statistical weight; see the 50-replication row below for the figure that does |
...
| Mean DOW/run (50-rep, seed=NULL, post-Issue-156) | 0.98; 95% CI [0.70, 1.26]. DOW/WIA rate 0.659% (95% CI [0.469%, 0.850%]); treated-cohort DOW rate (casualties reaching R2B or R2E) 0.442% (95% CI [0.316%, 0.568%]), the quantity the historical Ajax Bay target of ~0.46% applies to — the interval spans the target, so `p1_p_max` and `p2_p_max` were left unchanged. Was 1.34, 95% CI [0.94, 1.74], treated-cohort 0.633% (95% CI [0.392%, 0.874%]) post-Issue-152 |
| DNBI sub-types (seed 42, post-Issue-156) | battle_fatigue=43, disease=106, nbi=21 (post-Issue-156; was battle_fatigue=40, disease=94, nbi=36 post-Issue-161) — RNG-stream-shifted despite DNBI sub-type assignment itself being unrelated code, per the single-global-RNG-stream mechanism (see provenance caveat above) |
| bf_rtd (seed 42, post-Issue-156) | 39 (post-Issue-156; was 34 post-Issue-161) |
| clinical_rtd (seed 42, post-Issue-156) | 101 (r1: 51, r2b: 39, r2e: 11) (post-Issue-156; was 114 — r1: 60, r2b: 44, r2e: 10 — post-Issue-161) |
| total_rtd (seed 42, post-Issue-156) | 140 (post-Issue-156; was 148 post-Issue-161) |
| Realised in-theatre share (seed 42, post-Issue-156, new row) | 30.3% of 119 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input: the previous `in_theatre_rate = 0.1` parameter is removed. Across 50 replications 28.9% (95% CI [27.7%, 30.1%]), inside the 7.6%-42.1% historical range cited in README Return to Duty |
| Evacuation is severity-conditioned (seed 42, post-Issue-156, new row) | Sorting the 119 dispositions into quartiles by drawn `recovery_to_duty_days` gives evacuation rates of 0% / 80% / 100% / 100% from shortest to longest recovery (50-rep: 0% / 84.3% / 100% / 100%). The previous unconditioned draw gave the same 90% rate in every quartile |
| Pre-flight critical ICU hold (seed 42, post-Issue-156, new row) | 6 of 42 critical-route evacuees drew the ventilated pre-flight path (`critical_hold.ventilated_share = 0.15`); 3 completed within the run at a mean of 26.4 h, median 29.1 h, against the ~12-day mean ICU occupancy the previous design produced. Across 50 replications the median is 26.4 h but the mean is 80.1 h and the p90 roughly 12 days, the tail being step-downs blocked by a full holding pool (README Limitation L17) |
| Welch ICU-queue CMA (10 reps × 90 days, post-Issue-156, new row) | Final cross-replication CMA 1.18 with 9.0% of increments decreasing, instantaneous mean queue peaking at 3.10; was 30.6 with 0% decreasing and a 56.9 peak before this change. A control run with `ventilated_share = 0` gives a CMA of 0.05 with 59.8% of increments decreasing and a peak queue of 0.40, which identifies the residual rise as blocked ICU step-downs rather than clinical ICU demand |
...
| R2B surgeries (seed 42, post-Issue-156) | 49 (post-Issue-156; was 52 post-Issue-161) |
| R2E surgeries — first op (seed 42, post-Issue-156) | 119 (post-Issue-156; was 103 post-Issue-161) — the rise is the ICU gate admitting far more casualties to theatre once evacuation-blocked beds are freed |
| R2E surgeries — second op (seed 42, post-Issue-156) | 48 (post-Issue-156; was 55 post-Issue-161) |
| R2B pre-transport bypass (seed 42, post-Issue-156) | upstream R1-threshold bypass: 121 (was 109 post-Issue-161); at-R2B hold-full bypass: 0 (unchanged); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-156) | at-R2B subset, 74 total (was 73 post-Issue-161): team off-shift 62 (was 67), OT busy/queued 12 (was 6) |
...
| R2E OT utilisation — 24h room (seed 42, post-Issue-156) | OT1: 62.6%, OT2: 48.3% (was OT1: 35.7%, OT2: 15.0% post-Issue-161). A theatre is seized before its surgical section, so a room reads as occupied while its casualty is still queued for staff; most of the rise is that wait, not operating time |
| R2E OT queue ≥1 (seed 42, post-Issue-156) | OT1: 30.2% of run, OT2: 23.9% (was OT1: 3.10%, OT2: 0.08% post-Issue-161) |
| R2E surgical section utilisation (seed 42, post-Issue-156) | Section 1: 21.4%, Section 2: 47.0%, Section 3: 21.9% of rostered time; queued ≥1 for 1.38%, 15.65% and 4.61% of rostered time respectively (was 19.9/35.4/19.1% and 3.36/3.56/0.26% post-Issue-161). Section 2 is higher because it is the section rostered to the second shift and so carries the whole night-time surgical load alone |
| R2E ICU utilisation — mean (seed 42, post-Issue-156) | ICU1: 78.7%, ICU2: 92.6%, ICU3: 61.1%, ICU4: 71.0% (was ICU1: 100.0%, ICU2: 100.0%, ICU3: 98.8%, ICU4: 99.8% post-Issue-161). Casualties awaiting strategic AME now stage in holding beds; only the ventilated share of the critical pool holds an ICU bed, for a bounded pre-flight period (README Limitation L17) |
| R2E ICU queue ≥1 (seed 42, post-Issue-156) | ICU1: 30.6% of run, ICU2: 71.1%, ICU3: 10.6%, ICU4: 39.6% (was ICU1: 95.5%, ICU2: 95.0%, ICU3: 94.3%, ICU4: 95.5% post-Issue-161) |
...
| R2E post-op pathway (seed 42, post-Issue-156) | icu=72, hold=47 (post-Issue-156; was icu=9, hold=94 post-Issue-161) — the split reverses once the evacuation backlog is moved off ICU beds; see README Limitation L17. `surgery_deferred` = 20 (was 24 post-Issue-161) |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-156) | 0/72 vs 0/47 (single-run; was 0/9 vs 0/94 post-Issue-161; saturated-ICU 90-day stress test from Issue #43 confirms mechanism fires, hold pathway > icu pathway — stress test predates this refresh and has not been re-run) |
...
| Role 4 demand (seed 42, post-Issue-156) | 83 strategic evacuation decisions (42 critical-route, 41 standard-route); 25 boarded and reached Role 4 by day 30 (6 critical, 19 standard), 58 still queued at R2E (36 critical, 22 standard); Role 4 peak occupancy 17.0 concurrent patients (day 15); unconstrained-baseline demand would need 27 sorties at same-day/uncapped/best-case (20/sortie) capacity. Was 116 decisions (81/35), 76 queued (73/3), peak 20.0, 29 sorties post-Issue-161. The fall in decisions is the evacuation policy retaining ~30% in theatre where the previous fixed rate retained 10% |
| Strategic AME actual performance (seed 42, post-Issue-156) | Configuration A (2 critical/8 standard) selected at all 3 of 3 successful sorties (7-day interval, 15% failure probability, 1 cancellation drawn at day 21); critical-pool mean wait 6.0 days (p10–p90 4.6–8.1); standard-pool mean wait 5.2 days (p10–p90 1.7–11.8); was 12.0 (4.3–18.9) and 4.0 (1.0–6.0) post-Issue-161. The boarded cohort is small and self-selecting, so the shorter critical wait should not be read as improved throughput; see [Strategic Evacuation and Role 4 Demand](docs/Single_Run_Analysis.md#strategic-evacuation-and-role-4-demand) |
| AME wait-time DOW poll (seed 42, post-Issue-156) | `dow_echelon=5`, daily poll interval (`role4.ame.dow_check_interval = 1440` min); 0 deaths observed in this seed-42 run, as post-Issue-161; see README [AME Wait Checkpoint](README.md#ame-wait-checkpoint) for why neither single-run count should be read as evidence about the mechanism's magnitude |
