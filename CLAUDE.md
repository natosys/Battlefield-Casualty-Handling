...
|---|---|
| Total casualties (30 days) | 386 (post-Issue-18; was 400 pre-Issue-18) |
| WIA (combat + support) | 149 (post-Issue-18; was 154) |
| KIA (combat + support) | 67 (post-Issue-18; was 70) |
| DNBI (combat + support) | 170 (post-Issue-18; was 176) |
| Effective force size, end of run (seed 42, post-Issue-18, new row) | combat: 2330 of 2500 initial (−6.8%); support: 1176 of 1250 initial (−5.9%); no reinforcement (`force_regeneration.reinforcement.interval_days = 0`, the shipped default) |
| Force regeneration reinforcement schedule (new row) | Disabled by default (`interval_days = 0`, `combat_size = 0`, `support_size = 0`) — a planner-configured, not auto-balanced, input; see README [Force Regeneration and the Endogenous Feedback Loop](README.md#6-force-regeneration-and-the-endogenous-feedback-loop) for a `high_intensity`-scenario demonstration of the mechanism under both no-reinforcement and weekly-reinforcement configurations |
| Priority 1 share (of 400 total) | ~53.3% (pre-dates the Issue #73 follow-up RNG-stream shift; not yet re-derived against a current-code baseline — post-Issue-76 seed-42 priority split is P1 202/P2 74/P3 54/KIA 70, i.e. 50.5% P1, but this reflects both the Issue #73 follow-up and Issue #76 shifts combined and should not be treated as isolating either; not recomputed post-Issue-18) |
| DOW count (seed 42) | 0 (post-Issue-18, unchanged; was 0 pre-Issue-18, down from 3 pre-Issue-76) — RNG-stream-shifted, not a change in DOW logic itself; mean ~0.70/run (50-rep, seed=NULL) figure predates the Issue #73 follow-up, Issue #76, and Issue #18 RNG-stream shifts and has not been refreshed |
...
| Mean DOW/run (50-rep, seed=NULL) | ~0.70 (0.45% of WIA); 95% CI [0.41, 0.95] — predates the Issue #73 follow-up, Issue #76, and Issue #18 RNG-stream shifts; not yet refreshed |
| DNBI sub-types (seed 42) | battle_fatigue=47, disease=99, nbi=24 (post-Issue-18; was battle_fatigue=38, disease=99, nbi=39 pre-Issue-18) |
| bf_rtd (seed 42) | 46 (post-Issue-18; was 35 pre-Issue-18) |
| clinical_rtd (seed 42) | 96 (r1: 48, r2b: 39, r2e: 9) (post-Issue-18; was 113 — r1: 65, r2b: 39, r2e: 9 — pre-Issue-18) |
| total_rtd (seed 42) | 142 (post-Issue-18; was 148 pre-Issue-18) |
| R2B surgical candidates (seed 42, post-Issue-76) | 141 (was 132 pre-Issue-76); not recomputed post-Issue-18 |
| R2B surgeries (seed 42, post-Issue-76) | 62 (was 47 pre-Issue-76); not recomputed post-Issue-18 |
| R2E surgeries — first op (seed 42, post-Issue-18) | 124 (post-Issue-18; was 142 pre-Issue-18) |
| R2B pre-transport bypass (seed 42, post-Issue-18) | upstream R1-threshold bypass: 112 (was 115 pre-Issue-18); at-R2B hold-full bypass: 1 (was 0); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-18) | at-R2B subset, 66 total (was 78 pre-Issue-18): team off-shift 61 (was 73), OT busy/queued 5 (unchanged) |
| OT utilisation — echelon aggregate (seed 42, post-Issue-18, coarser grain than the per-room rows below) | R2B: 4.7%, R2E: 16.0% — this refresh's `analyse_run()` output reports an aggregate per-echelon figure only; the per-room breakdown in the rows immediately below was not independently re-derived and remains as last refreshed (pre-Issue-18) |
| R2B OT utilisation — 24h room (seed 42, post-Issue-76) | T1: 6.7%, T2: 9.3% (was T1: 8.5%, T2: 7.4% pre-Issue-76); not recomputed post-Issue-18 |
| R2B OT utilisation — shift time (seed 42, post-Issue-73) | T1: 14.4%, T2: 13.9% — pre-dates Issue #76; not recomputed in this or the Issue #76 refresh |
| R2E OT utilisation — 24h room (seed 42, post-Issue-76) | OT1: 40.8%, OT2: 16.9% (was OT1: 47.9%, OT2: 24.4% pre-Issue-76); not recomputed post-Issue-18 |
| R2E ICU utilisation — mean (seed 42, post-Issue-76) | ICU1: 76.6%, ICU2: 62.1%, ICU3: 59.6%, ICU4: 47.0% (was ICU1: 76.8%, ICU2: 74.8%, ICU3: 57.8%, ICU4: 52.8% pre-Issue-76); not recomputed post-Issue-18 |
| R2E ICU queue ≥1 (seed 42, post-Issue-76) | ICU1: 11.2% of run, ICU2: 2.2% of run, ICU3: 0% of run, ICU4: 0% of run (was ICU1: 15.3%, ICU2: 2.3%, ICU3: 0%, ICU4: 0% pre-Issue-76); not recomputed post-Issue-18 |
| Transport utilisation — platform aggregate (seed 42, post-Issue-18, coarser grain than the per-vehicle rows below) | HX240M: 4.6%, PMVAmb: 9.8% — this refresh's `analyse_run()` output reports an aggregate per-platform figure only; the per-vehicle breakdown in the rows immediately below was not independently re-derived and remains as last refreshed (pre-Issue-18) |
| PMV Ambulance utilisation (seed 42, post-Issue-76) | 10.4% (was 10.8%); max queue 0 throughout run; per-vehicle 25.5% / 5.3% / 0.6% (was 26.2% / 5.2% / 0.9%); not recomputed post-Issue-18 |
| HX240M utilisation (seed 42, post-Issue-76) | 4.8% (was 5.2%); max queue 0 throughout run; per-vehicle 8.6% / 1.0% (was 9.1% / 1.3%) — carries R2B→R2E mortuary road-move traffic in addition to R1→mortuary KIA; not recomputed post-Issue-18 |
...
| R2B→R2E mortuary transport (seed 42, Issue #73 follow-up) | R2B KIA/DOW transported by road to the R2E-collocated mortuary via the shared HX2 40M fleet (`r2b_transport_kia()`, dead-heading return leg), then handed to a selected R2E team's mortuary intake (`r2e_mortuary_intake()`); exact post-Issue-18 KIA/DOW split not recomputed |
| R2E post-op pathway (seed 42, post-Issue-18) | icu=110, hold=14 (ICU saturated, P1 override); surgery_deferred=3 (ICU saturated, P2+) (post-Issue-18; was icu=110, hold=31, surgery_deferred=13 pre-Issue-18) |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-18) | 0/110 vs 0/14 (single-run; was 0/110 vs 0/31 pre-Issue-18; saturated-ICU 90-day stress test from Issue #43 confirms mechanism fires, hold pathway > icu pathway — stress test predates this refresh and has not been re-run) |
| Mean DOW/run — pre- vs post-Issue-43 (50-rep, seed=NULL) | 0.84 (95% CI [0.58, 1.10]) → 1.00 (95% CI [0.74, 1.26]); CIs overlap (not significant at n=50); +0.10/run attributable to the new post-op checkpoint alone (5/50 reps) — predates the Issue #73 follow-up, Issue #76, and Issue #18 RNG-stream shifts; not yet refreshed |
| R2E post-op DOW rate — icu vs hold (50-rep, Issue #43) | icu: 3/5,085 (0.06%); hold: 2/1,223 (0.16%) — hold ≈2.8× icu, consistent with intended design at real (non-stress-tested) parameters — predates the Issue #73 follow-up, Issue #76, and Issue #18 RNG-stream shifts; not yet refreshed |
| R2E ICU utilisation — mean (50-rep, pre- vs post-Issue-43) | 74.1% → 60.2% — predates the Issue #73 follow-up, Issue #76, and Issue #18 RNG-stream shifts; not yet refreshed |
