...
|---|---|
| Total casualties (30 days) | 382 (unchanged post-Issue-146; 382 post-Issue-148, was 386 post-Issue-173, 385 post-Issue-159, 386 post-Issue-160, 387 post-Issue-161, 400 pre-Issue-18) |
| WIA (combat + support) | 151 (unchanged post-Issue-146; 151 post-Issue-148, was 149 post-Issue-173, 148 post-Issue-159, 149 post-Issue-160, 150 post-Issue-161, 154 pre-Issue-18). Rises because the mean-relative cap is looser on the WIA streams than the fixed cap of 5 was |
| KIA (combat + support) | 57 (unchanged post-Issue-146; 57 post-Issue-148, was 67 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 70 pre-Issue-18). The largest single-stream movement of this refresh: the retired fixed cap of 5 sat at 7.4 times the KIA streams' own mean of 0.68 and so barely bound them, where the mean-relative cap binds them as it binds every other stream |
| DNBI (combat + support) | 174 (unchanged post-Issue-146; 174 post-Issue-148, was 170 post-Issue-173, post-Issue-159, post-Issue-160 and post-Issue-161, 176 pre-Issue-18) |
| Effective force size, end of run (seed 42, post-Issue-146) | combat: 2330 of 2500 initial (−6.8%); support: 1184 of 1250 initial (−5.3%); no reinforcement (`force_regeneration.reinforcement.demand_interval_days = 0`, the shipped default). Was combat 2332 / support 1185 post-Issue-148 |
...
| Priority 1 share (seed 42, post-Issue-146) | 219 of 382 classified (57.3%) — P1 219 / P2 50 / P3 56 / KIA 57; was P1 206 / P2 67 / P3 52 / KIA 57 post-Issue-148. Every generated casualty carries an assigned priority in this run |
| DOW count (seed 42, post-Issue-146) | 1 total: r2b=1, r2e_postop=0, ame_wait=0; was 0 post-Issue-148. At n≤3 a change of one carries no statistical weight; see the pooled multi-replication row below for the figure that does |
...
| DNBI sub-types (seed 42, post-Issue-146) | battle_fatigue=38, disease=105, nbi=34 (post-Issue-146; was battle_fatigue=43, disease=101, nbi=30 post-Issue-148) — RNG-stream-shifted despite DNBI sub-type assignment itself being unrelated code, per the single-global-RNG-stream mechanism (see provenance caveat above) |
| bf_rtd (seed 42, post-Issue-146) | 32 (post-Issue-146; was 40 post-Issue-148), tracking the fall in the battle fatigue sub-type count above |
| clinical_rtd (seed 42, post-Issue-146) | 114 (r1: 65, r2b: 39, r2e: 10) (post-Issue-146; was 109, split 58 / 39 / 12, post-Issue-148) |
| total_rtd (seed 42, post-Issue-146) | 146 (post-Issue-146; was 149 post-Issue-148) |
| Realised in-theatre share (seed 42, post-Issue-146) | 24.5% of 151 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input. Was 36.7% of 139 dispositions post-Issue-148; the fall follows the larger operated cohort, an operated Priority 1 casualty drawing the longest recovery-to-duty factor and so evacuating. The 50-replication figure was not recomputed for Issue #146 and remains 26.8% (95% CI [25.5%, 28.0%]), inside the 7.6%-42.1% historical range cited in README Return to Duty |
| Evacuation is severity-conditioned (seed 42, post-Issue-146) | Sorting the 151 dispositions into quartiles by drawn `recovery_to_duty_days` gives evacuation rates of 2.6% / 100% / 100% / 100% from shortest to longest recovery; was 0% / 54.3% / 100% / 100% post-Issue-148. An unconditioned draw would give the same rate in every quartile. The 50-replication figure was not recomputed and remains 0.0% / 93.5% / 100% / 100% |
| Pre-flight critical ICU hold (seed 42, post-Issue-146) | 15 critical-route evacuees drew the ventilated pre-flight path (`critical_hold.ventilated_share = 0.15`); 8 completed within the run at a mean of 25.0 h, median 25.1 h, p90 33 h. Was 10 with 5 completed at a mean of 24.1 h post-Issue-148. The 50-replication figures were not recomputed and remain 31.9 h mean, 24.3 h median, 32 h p90 as last measured post-Issue-160 |
...
| Surgical pathway split (seed 42, post-Issue-146) | 120 casualties operated on: 66 damage control (55.0%), 54 single-stage. By priority, Priority 1 105 operated / 63 damage control (60.0%, configured rate 55%), Priority 2 15 operated / 3 damage control (20.0%, configured 20%); no Priority 3 casualty reached theatre in this run. Was 115 operated, 66 damage control (57.4%) post-Issue-148; a single run of about a hundred draws sits this far from its configured rate routinely. The 50-replication share was not recomputed and remains 48.3% (95% CI [47.0%, 49.5%]) |
...
| R2B surgical decision point (seed 42, post-Issue-146) | 118 casualties reached it (49 operated at R2B, 69 bypassed to R2E); was 118 (54 operated, 64 bypassed) post-Issue-148 |
| R2B surgeries (seed 42, post-Issue-146) | 49 (post-Issue-146; was 54 post-Issue-148). A fall at this seed against a rise of 5.6 per run across 50 replications; see the provenance caveat above and the replicated comparison in `docs/Multi_Run_Analysis.md` |
| R2E surgeries — first op (seed 42, post-Issue-146) | 96 (post-Issue-146; was 98 post-Issue-148) |
| R2E surgeries — second op (seed 42, post-Issue-146) | 38 (post-Issue-146; was 21 post-Issue-148). Only a damage control casualty whose abbreviated operation was performed at R2E returns for a second procedure, so this stays at roughly the damage control share of casualties not operated on forward |
| R2B pre-transport bypass (seed 42, post-Issue-146) | upstream R1-threshold bypass: 118 (unchanged from post-Issue-148); at-R2B hold-full bypass: 0 (unchanged); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-146) | at-R2B subset, 69 total (was 64 post-Issue-148): team off-shift 53 (was 59), OT busy/queued 16 (was 5). The off-shift count falls with the pre-open hold, which is what the hold is for; across 50 replications it falls from 65.7 (95% CI [64.0, 67.3]) to 62.0 ([60.0, 64.0]) while the OT-busy count is unmoved, 7.56 ([6.75, 8.37]) against 7.10 ([6.18, 8.02]), so the single-run rise in the busy count is sampling variation rather than displacement by the hold |
| R2B pre-open hold (seed 42, post-Issue-146) | 7 casualties held forward for a section about to reopen, all 7 operated on within the run, mean hold 40.9 minutes, longest 57.1, against the shipped 60-minute `r2b.surgery.pre_open_window_min`. New in Issue #146. Across 50 replications, 5.6 held per run (95% CI [5.0, 6.3]) |
| OT utilisation — echelon aggregate (seed 42, post-Issue-146) | R2B: 4.9%, R2E: 15.6% (was R2B: 5.8%, R2E: 10.8% post-Issue-148) |
| R2B OT utilisation — 24h room (seed 42, post-Issue-146) | T1: 7.6%, T2: 6.2% (was T1: 7.3%, T2: 6.7% post-Issue-148). Across 50 replications the two-room mean rises from 7.4% (95% CI [7.2%, 7.6%]) at a zero window to 8.3% ([8.0%, 8.6%]) at the shipped 60 minutes |
| R2B OT utilisation — shift time (seed 42, post-Issue-146) | T1: 13.9%, T2: 11.9% — theatre occupancy measured against the section's own roster. Was T1: 14.5%, T2: 13.4% post-Issue-148. This no longer runs at exactly twice the 24-hour room figure above: the pre-open hold occupies the theatre while the section is off shift, so some of the room's occupancy now falls outside the roster this row divides by |
| R2E OT utilisation — 24h room (seed 42, post-Issue-146) | OT1: 41.6%, OT2: 22.7% (was OT1: 25.2%, OT2: 8.4% post-Issue-148). A theatre is seized before its surgical section, so a room reads as occupied while its casualty is still queued for staff; much of this is that wait, not operating time |
| R2E OT queue ≥1 (seed 42, post-Issue-146) | OT1: 15.9% of run, OT2: 10.4% (was OT1: 1.1%, OT2: 0% post-Issue-148) |
| R2E surgical section utilisation (seed 42, post-Issue-146) | Section 1: 19.7%, Section 2: 31.3%, Section 3: 13.7% of rostered time, queued for 0.84%, 1.84% and 0.60% of it (was 15.4/29.7/18.0% utilisation queued 0/3.98/0.14% post-Issue-148). Section 2 remains the busiest, being the section rostered to the second shift and so carrying the whole night-time surgical load alone |
| R2E ICU utilisation — mean (seed 42, post-Issue-146) | ICU1: 90.0%, ICU2: 86.0%, ICU3: 82.1%, ICU4: 78.9% (was ICU1: 91.7%, ICU2: 92.7%, ICU3: 88.4%, ICU4: 85.4% post-Issue-148). The 50-replication figure was not recomputed for Issue #146 and remains a four-bed mean of 79.7% (95% CI [78.4%, 81.0%]), computed by the project's own `utilisation_per_replication()` (R/analysis.R) |
| R2E ICU queue ≥1 (seed 42, post-Issue-146) | ICU1: 35.6% of run, ICU2: 16.6%, ICU3: 10.8%, ICU4: 1.2% (was ICU1: 44.6%, ICU2: 33.7%, ICU3: 23.0%, ICU4: 0% post-Issue-148) |
| Transport utilisation — platform aggregate (seed 42, post-Issue-146) | HX240M: 2.7%, PMVAmb: 10.2% (was HX240M: 4.1%, PMVAmb: 10.3% post-Issue-148) |
| PMV Ambulance utilisation (seed 42, post-Issue-146) | 10.2%; max queue 0 throughout run; per-vehicle 24.1% / 6.3% / 0.3% (was 24.9% / 5.4% / 0.5% post-Issue-148) |
| HX240M utilisation (seed 42, post-Issue-146) | 2.7%; max queue 0 throughout run; per-vehicle 7.1% / 0.7% / 0.1% (was 7.7% / 0.6% post-Issue-148) — carries R2B→R2E mortuary road-move traffic in addition to R1→mortuary KIA |
...
| R2E post-op pathway — stabilisation (seed 42, post-Issue-146) | icu=44, hold=43 (post-Issue-146; was icu=37, hold=49 post-Issue-148). The degraded share falls back from 57% to 49%. `surgery_deferred` = 7 (was 17 post-Issue-148); across 50 replications it moves 12.4 (95% CI [11.4, 13.4]) to 11.2 ([10.2, 12.2]) |
| R2E post-definitive care pathway (seed 42, post-Issue-146) | icu=51, hold=65 — 44% of operated casualties receive post-definitive care in an ICU bed, level with post-Issue-148, the remainder taking the degraded holding-bed fallback. The 50-replication ICU share was not recomputed and remains 48.6% (95% CI [47.0%, 50.1%]). Four ICU beds still cannot cover both episodes for everyone |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-146) | 0/44 vs 0/43 (single-run; was 0/37 vs 0/49 post-Issue-148). The saturated-ICU 90-day stress test from Issue #43, which confirmed the mechanism fires with the hold pathway riskier than the icu pathway, has not been re-run since |
| Role 4 demand (seed 42, post-Issue-146) | 114 strategic evacuation decisions; 105 boarded and reached Role 4 by day 30, 9 still queued at R2E; Role 4 peak occupancy 67.0 concurrent patients (day 26); unconstrained-baseline demand would need 28 sorties. Was 88 decisions, 67 boarded, 21 queued, peak 49.0 on day 17, 26 sorties post-Issue-148. Demand rises with the lower in-theatre retention share |
| Strategic AME actual performance (seed 42, post-Issue-146) | C-17A Globemaster III at 36 critical / 54 standard places; 105 evacuated at a mean wait of 0.7 days (p10-p90 0.0-3.0). Was 67 evacuated at a mean wait of 0.9 days post-Issue-148 |
| AME wait-time DOW poll (seed 42, post-Issue-146) | `dow_echelon=5`, daily poll interval (`role4.ame.dow_check_interval = 1440` min); 0 deaths observed, as in every run since the poll was added; see README [AME Wait Checkpoint](README.md#ame-wait-checkpoint) for why no single-run count should be read as evidence about the mechanism's magnitude |
