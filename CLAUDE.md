...
| Effective force size, end of run (seed 42, post-Issue-18, new row) | combat: 2330 of 2500 initial (−6.8%); support: 1176 of 1250 initial (−5.9%); no reinforcement (`force_regeneration.reinforcement.demand_interval_days = 0`, the shipped default) — figure unchanged by the demand/lag/triangular-fill reinforcement redesign, confirmed RNG-neutral when disabled |
