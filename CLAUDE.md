...
| Realised in-theatre share (seed 42, post-Issue-173) | 32.4% of 139 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input. Across 50 independent replications 26.8% (95% CI [25.5%, 28.0%]), inside the 7.6%-42.1% historical range cited in README Return to Duty. Was 24.5% of 143 dispositions (50-rep not measured) post-Issue-159 |
| Evacuation is severity-conditioned (seed 42, post-Issue-173) | Sorting the 139 dispositions into quartiles by drawn `recovery_to_duty_days` gives evacuation rates of 0% / 71.4% / 100% / 100% from shortest to longest recovery (50-rep: 0.0% / 93.5% / 100% / 100%). An unconditioned draw would give the same rate in every quartile |
...
| R2E ICU utilisation — mean (seed 42, post-Issue-173) | ICU1: 93.3%, ICU2: 88.4%, ICU3: 83.6%, ICU4: 73.0% (was ICU1: 97.4%, ICU2: 94.4%, ICU3: 93.5%, ICU4: 88.7% post-Issue-159). Across 50 independent replications the four-bed mean is 79.7% (95% CI [78.4%, 81.0%]), computed by the project's own `utilisation_per_replication()` (R/analysis.R). This is the largest movement of any re-measured 50-replication row and the intervals do not overlap; the point estimate is unbiased either way, so the shift is the seed draw, and the row should be read as re-measured rather than as a change in behaviour |
