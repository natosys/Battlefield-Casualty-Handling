...
| `scripts/check_dow_calibration.R` | Regression check asserting that neither shipped configuration's treated-cohort died-of-wounds rate overshoots the Ajax Bay bound, pooling independent measurements at pair level; exits non-zero on failure |
