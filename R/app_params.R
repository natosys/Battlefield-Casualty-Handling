...
SRC_DOW_CEILING       <- "Calibrated to the Falklands War 1982 died-of-wounds outcome at Ajax Bay — three deaths among the more than 650 casualties who reached that surgical chain (Westphalen, 2018) — via 50-replication Monte Carlo; entangled with the OIF/OEF-era treatment efficacy factors below it. See README Died of Wounds."
