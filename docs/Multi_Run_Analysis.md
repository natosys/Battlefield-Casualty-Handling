...
|---|---|---|---|
| Total casualties/run | 437.8 (p10–p90: 362.7–528.0) | 992.3 (p10–p90: 888.4–1,119.7) | 2.27× |
| WIA/run | 188.7 (137.6–251.5) | 662.1 (539.4–784.9) | 3.51× |
| DOW/run | 0.78 (0–2.0) | 5.80 (3.0–9.0) | 7.44× |
| DOW/WIA rate | 0.42% (95% CI [0.29%, 0.54%]) | 0.88% (95% CI [0.78%, 0.99%]) | 2.11× |
