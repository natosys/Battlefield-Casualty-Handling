...
|---|---|
| Total casualties (30 days) | 385 (post-Issue-159; was 386 post-Issue-160, 385 post-Issue-156, 387 post-Issue-161, 400 pre-Issue-18) |
| WIA (combat + support) | 148 (post-Issue-159; was 149 post-Issue-160, 148 post-Issue-156, 150 post-Issue-161, 154 pre-Issue-18) |
...
| Effective force size, end of run (seed 42, post-Issue-159) | combat: 2324 of 2500 initial (−7.0%); support: 1175 of 1250 initial (−6.0%); no reinforcement (`force_regeneration.reinforcement.demand_interval_days = 0`, the shipped default). Was combat 2330 / support 1176 when last measured, post-Issue-18 |
...
| Priority 1 share (seed 42, post-Issue-159) | 215 of 385 classified (55.8%) — P1 215 / P2 67 / P3 36 / KIA 67; was P1 208 / P2 66 / P3 45 / KIA 67 post-Issue-160. Every generated casualty carries an assigned priority in this run |
| DOW count (seed 42, post-Issue-159) | 2 total: r2b=1, r2e_postop=1, ame_wait=0; was 1 (r2b=1) post-Issue-160. This is the first run in which the post-operative checkpoint has produced a death, which follows from the added post-definitive episode extending time at risk. At n≤3 a change of one carries no statistical weight; see the 50-replication row below for the figure that does |
...
| DNBI sub-types (seed 42, post-Issue-159) | battle_fatigue=52, disease=92, nbi=26 (post-Issue-159; was battle_fatigue=31, disease=109, nbi=30 post-Issue-160) — RNG-stream-shifted despite DNBI sub-type assignment itself being unrelated code, per the single-global-RNG-stream mechanism (see provenance caveat above) |
| bf_rtd (seed 42, post-Issue-159) | 48 (post-Issue-159; was 28 post-Issue-160) |
| clinical_rtd (seed 42, post-Issue-159) | 86 (r1: 38, r2b: 39, r2e: 9) (post-Issue-159; was 104 — r1: 52, r2b: 41, r2e: 11 — post-Issue-160) |
| total_rtd (seed 42, post-Issue-159) | 134 (post-Issue-159; was 132 post-Issue-160) |
| Realised in-theatre share (seed 42, post-Issue-159) | 24.5% of 143 R2E dispositions retained in theatre under the shipped 30-day `evacuation_policy_days`. An output of the policy, not an input. Across 50 replications 26.9% (95% CI [25.8%, 27.9%]), inside the 7.6%-42.1% historical range cited in README Return to Duty. Was 30.3% of 119 dispositions (50-rep 28.9%) post-Issue-156; the disposition count rises because casualties clear R2E instead of queueing for a sortie |
...
| R2B surgical decision point (seed 42, post-Issue-159) | 123 casualties reached it (55 operated at R2B, 68 bypassed to R2E). Supersedes the "R2B surgical candidates = 141" row carried since Issue #76, which counted a different quantity and had not been recomputed since |
| R2B surgeries (seed 42, post-Issue-159) | 55 (post-Issue-159; was 46 post-Issue-160) |
| R2E surgeries — first op (seed 42, post-Issue-159) | 122 (post-Issue-159; was 123 post-Issue-160) |
| R2E surgeries — second op (seed 42, post-Issue-159) | 58 (post-Issue-159; was 73 post-Issue-160) |
| R2B pre-transport bypass (seed 42, post-Issue-159) | upstream R1-threshold bypass: 110 (was 134 post-Issue-160); at-R2B hold-full bypass: 0 (unchanged); R2B hold queue (both full): 0 (unchanged) — these are three independent, non-summing counts |
| R2B OT bypass reason (seed 42, post-Issue-159) | at-R2B subset, 68 total (was 80 post-Issue-160): team off-shift 61 (was 73), OT busy/queued 7 (unchanged) |
| OT utilisation — echelon aggregate (seed 42, post-Issue-159) | R2B: 5.2%, R2E: 17.5% (was R2B: 3.7%, R2E: 23.4% post-Issue-160) |
| R2B OT utilisation — 24h room (seed 42, post-Issue-159) | T1: 7.6%, T2: 8.9% (was T1: 5.1%, T2: 7.3% post-Issue-160) |
| R2B OT utilisation — shift time (seed 42, post-Issue-159) | T1: 10.9%, T2: 14.7% — the team being rostered 12 hours of every 24, this runs at roughly twice the 24-hour room figure above. Was T1: 10.2%, T2: 14.6% post-Issue-160 |
| R2E OT utilisation — 24h room (seed 42, post-Issue-159) | OT1: 55.1%, OT2: 32.1% (was OT1: 59.6%, OT2: 44.0% post-Issue-160). A theatre is seized before its surgical section, so a room reads as occupied while its casualty is still queued for staff; much of this is that wait, not operating time |
| R2E OT queue ≥1 (seed 42, post-Issue-159) | OT1: 21.9% of run, OT2: 5.0% (was OT1: 31.1%, OT2: 22.5% post-Issue-160) |
| R2E surgical section utilisation (seed 42, post-Issue-159) | Section 1: 20.5%, Section 2: 48.1%, Section 3: 20.4% of rostered time; no section carried a queue at any point in this run (was 24.8/53.1/19.7% utilisation and 3.14/23.20/1.81% queued post-Issue-160). Section 2 remains the busiest, being the section rostered to the second shift and so carrying the whole night-time surgical load alone, but the binding constraint has moved to ICU: the pre-OT gate now defers casualties before they reach a theatre, so they queue for a bed rather than for staff |
| R2E ICU utilisation — mean (seed 42, post-Issue-159) | ICU1: 97.4%, ICU2: 94.4%, ICU3: 93.5%, ICU4: 88.7% (was ICU1: 82.8%, ICU2: 87.2%, ICU3: 61.1%, ICU4: 54.2% post-Issue-160). The rise is the point of the change: three in four R2B-operated casualties previously drew a 60-minute R2E stay in place of the full requirement. The 50-replication four-bed mean was not recomputed and remains 68.9% as last measured post-Issue-160 |
| R2E ICU queue ≥1 (seed 42, post-Issue-159) | ICU1: 40.7% of run, ICU2: 20.3%, ICU3: 0%, ICU4: 0% (was ICU1: 23.3%, ICU2: 24.7%, ICU3: 0%, ICU4: 0% post-Issue-160) |
| Transport utilisation — platform aggregate (seed 42, post-Issue-159) | HX240M: 4.7%, PMVAmb: 10.4% (was HX240M: 4.7%, PMVAmb: 10.7% post-Issue-160) |
| PMV Ambulance utilisation (seed 42, post-Issue-159) | 10.4%; max queue 0 throughout run; per-vehicle 25.7% / 5.2% / 0.2% (was 25.1% / 6.0% / 1.0% post-Issue-160) |
| HX240M utilisation (seed 42, post-Issue-159) | 4.7%; max queue 0 throughout run; per-vehicle 9.1% / 0.2% (was 8.8% / 0.7% post-Issue-160) — carries R2B→R2E mortuary road-move traffic in addition to R1→mortuary KIA |
...
| R2E post-op pathway — stabilisation (seed 42, post-Issue-159) | icu=52, hold=70 (post-Issue-159; was icu=85, hold=38 post-Issue-160) — the degraded-care share rises back above half, because a conserved requirement plus a second episode keeps beds occupied far longer than the short stay it replaced; see README Limitations L17 and L24. `surgery_deferred` = 22 (was 6 post-Issue-160) |
| R2E post-definitive care pathway (seed 42, post-Issue-159) | icu=37, hold=72 — new in Issue #159, and the headline result of adding the episode: only 34% of casualties get an ICU bed after their definitive repair, the rest taking the degraded holding-bed fallback at elevated DOW risk. Four ICU beds cannot cover both the stabilisation and post-definitive episodes at Falklands-equivalent load |
| R2E post-op DOW rate — icu vs hold (seed 42, post-Issue-159) | 0/52 vs 1/70 (single-run; was 0/85 vs 0/38 post-Issue-160). The saturated-ICU 90-day stress test from Issue #43, which confirmed the mechanism fires with the hold pathway riskier than the icu pathway, has not been re-run since |
| Role 4 demand (seed 42, post-Issue-159) | 108 strategic evacuation decisions; 99 boarded and reached Role 4 by day 30, 9 still queued at R2E; Role 4 peak occupancy 59.0 concurrent patients (day 21); unconstrained-baseline demand would need 26 sorties. Was 121 decisions, 105 boarded, 16 queued, peak 73.0, 29 sorties post-Issue-160 — the fall follows from more casualties being retained in theatre once the post-definitive episode lengthens their stay |
| Strategic AME actual performance (seed 42, post-Issue-159) | C-17A Globemaster III at 36 critical / 54 standard places; 99 evacuated at a mean wait of 0.7 days (p10-p90 0.0-2.9). Was 105 evacuated, mean 1.1 days post-Issue-160 |
