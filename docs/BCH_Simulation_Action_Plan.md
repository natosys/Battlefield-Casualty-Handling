...
| 373 | Role 4 staged reconstruction is unrepresented, and the evacuation decision carries no reconstruction burden | Medium | Medium | Open |
...
### Phase 4 — Scenario Expansion (Issues 54 ✓, 9 ✓, 10 ✓, 57 ✓, 18 ✓, 23 ✓, 124 ✓, 160 ✓, 153 ✓, 148 ✓, 203 ✓, 206 ✓, 149 ✓, 151 ✓, 207 ✓, 295 ✓, 314 ✓, 368 ✓)
...
UNBLOCKED (start now):
  ...
  #373 Role 4 staged reconstruction is unrepresented, and the evacuation
       decision carries no reconstruction burden for it to be conditioned on,
       selecting on system load and recovery duration alone. Split from #368,
       which closed the conserved single operation. A series at one national
       support base puts the gap at 5.2 operations per casualty. Blocked on
       scoping what the evacuation decision must carry.
