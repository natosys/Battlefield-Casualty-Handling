...
### Phase 2 — Model Fidelity (Issues 8 ✓, 35 ✓, 37 ✓, 44 ✓, 6 ✓, 5 ✓, 43 ✓, 14 ✓, 73 ✓, 74 ✓, 85 ✓, 76 ✓, 161 ✓, 156 ✓, 159 ✓, 173 ✓, 180 ✓, 178 ✓, 146 ✓, 313 ✓)
...
UNBLOCKED (start now):
  ...
  #365 Allow strategic evacuation between the abbreviated operation and the
       definitive repair. Raised from #366: evacuation is the last phase of
       the R2E trajectory, so a damage control casualty cannot travel before
       their definitive repair. Role 4 demand is understated for the sickest
       cohort, theatre demand overstated, and the gap is coupled to the
       evacuation policy, so #363's policy sweep overstates the forward relief
       a shorter policy buys. A trajectory change: it moves the stream and
