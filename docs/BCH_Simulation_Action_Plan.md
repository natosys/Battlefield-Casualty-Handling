...
| 173 | Every casualty requiring surgery is routed through the damage control sequence | High | Medium | Open |
...
### Phase 2 — Model Fidelity (Issues 8 ✓, 35 ✓, 37 ✓, 44 ✓, 6 ✓, 5 ✓, 43 ✓, 14 ✓, 161 ✓)
...
UNBLOCKED (start now):
  #173 Damage control applied to every casualty requiring surgery
       (unblocked by #159, which raised it as Further Development L25;
       the literature puts damage control at roughly a quarter of
       emergent trauma laparotomies, so the intensive care constraint
       #159 reports is inflated until this is modelled)
