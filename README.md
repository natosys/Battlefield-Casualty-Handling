...
| ----------------------- | ---------------------------------- | ------------------------------------------------------------------ |
| Treated-cohort DOW rate | 0.279% (95% CI [0.227%, 0.331%])   | ≤0.46% (3 deaths among over 650 reaching forward surgery [[14]](#references)) |
