...
| 327 | The R2B hold occupancy figure omits every episode still running when the run ends | Medium | Low | Open |
...
### Phase 7 — Publication (Issues 238 ✓, 239 ✓, 240 ✓, 311 ✓, 315 ✓)
...
UNBLOCKED (start now):
  #327 The R2B hold occupancy figure omits every hold episode still running
       when the run ends, 9 of 50 at seed 42 over 30 days, all at the tail.
       Reaches images/r2b_hold_occupancy.png and the single-run paper's
       reading of it. Raised from the merge of #316.
